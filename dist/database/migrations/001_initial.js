...
async function up(db) {
    ...
    await db.schema
        ...
        .addColumn('tenant_id', 'uuid', (col) => col.notNull())
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_org_members_org', ['organization_id'], 'organizations', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_org_members_user', ['user_id'], 'users', ['id'], (cb) => cb.onDelete('cascade'))
    ...
    await db.schema
        ...
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addColumn('updated_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_projects_org', ['organization_id'], 'organizations', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_projects_created_by', ['created_by'], 'users', ['id'])
        .execute();
    await db.schema
        .createTable('tasks')
        .addColumn('id', 'uuid', (col) => col.primaryKey().defaultTo((0, kysely_1.sql) `gen_random_uuid()`))
        ...
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addColumn('updated_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_tasks_project', ['project_id'], 'projects', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_tasks_org', ['organization_id'], 'organizations', ['id'])
        .addForeignKeyConstraint('fk_tasks_assigned_to', ['assigned_to'], 'users', ['id'])
        .execute();
    await db.schema
        ...
        .addColumn('tenant_id', 'uuid', (col) => col.notNull())
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_comments_task', ['task_id'], 'tasks', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_comments_user', ['user_id'], 'users', ['id'])
        .addForeignKeyConstraint('fk_comments_org', ['organization_id'], 'organizations', ['id'])
        .execute();
    await db.schema
        ...
        .addColumn('tenant_id', 'uuid', (col) => col.notNull())
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_attachments_task', ['task_id'], 'tasks', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_attachments_user', ['uploaded_by'], 'users', ['id'])
        .addForeignKeyConstraint('fk_attachments_org', ['organization_id'], 'organizations', ['id'])
        .execute();
    await db.schema
        ...
        .addColumn('tenant_id', 'uuid', (col) => col.notNull())
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_notifications_user', ['user_id'], 'users', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_notifications_org', ['organization_id'], 'organizations', ['id'])
        .execute();
    await db.schema
        ...
        .addColumn('tenant_id', 'uuid', (col) => col.notNull())
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_audit_logs_org', ['organization_id'], 'organizations', ['id'])
    ...
    await db.schema
        ...
        .addColumn('tenant_id', 'uuid', (col) => col.notNull())
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_refresh_tokens_user', ['user_id'], 'users', ['id'], (cb) => cb.onDelete('cascade'))
        .execute();
    await db.schema
        ...
        .addColumn('tenant_id', 'uuid', (col) => col.notNull())
        .addColumn('created_at', 'timestamp', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addForeignKeyConstraint('fk_project_members_project', ['project_id'], 'projects', ['id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_project_members_user', ['user_id'], 'users', ['id'], (cb) => cb.onDelete('cascade'))
        .execute();
    await db.schema
